...
<div id="menu" class="fa fa-bars" @click="toggleMenu()"></div>
...
<div class="row">
    ...
    <div class="content">
        ...
        <div class="info">
            <h3> <i class="fa fa-envelope"></i> shaikh@gmail.com </h3>
            <h3> <i class="fa fa-phone"></i> +123-456-7890 </h3>
            <h3> <i class="fa fa-phone"></i> +111-222-3333 </h3>
            <h3> <i class="fa fa-map-marker"></i> mumbai, india - 400104. </h3>
        </div>
