...
<div class="body0">
        ...
        <header class="l-header">
            <nav class="nav bd-grid">
                <div>
                    <a href="#" class="nav__logo">D'avila</a>
                </div>

                <div class="nav__menu" id="nav-menu" :class="menuOpen? 'show':''">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item"><a href="#work" class="nav__link">Expérience</a></li>
        ...
        <main class="l-main">
            ...
            <section class="home" id="home">
                <div class="home__data">
                    <h1 class="home__title">Salut,<br>Je suis <span class="home__title-color">D'avila</span><br>Experte Comptable</h1>

                    <a href="#" class="button">Me Contacter</a>

                    <div class="home__social">
                        <a href="" class="home__social-icon"><i class='fa fa-linkedin'></i></a>
                        <a href="" class="home__social-icon"><i class='fa fa-behance' ></i></a>
                        <a href="" class="home__social-icon"><i class='fa fa-github' ></i></a>
                    </div>
                ...
                <div class="home__img">
                    <svg class="home__blob" viewBox="0 0 479 467" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <g mask="url(#mask0)">
                            <path d="M9.19024 145.964C34.0253 76.5814 114.865 54.7299 184.111 29.4823C245.804 6.98884 311.86 -14.9503 370.735 14.143C431.207 44.026 467.948 107.508 477.191 174.311C485.897 237.229 454.931 294.377 416.506 344.954C373.74 401.245 326.068 462.801 255.442 466.189C179.416 469.835 111.552 422.137 65.1576 361.805C17.4835 299.81 -17.1617 219.583 9.19024 145.964Z"/>
                            <image class="home__blob-img" x="0" y="10" xlink:href="./assets/img/002.png"/>
                        </g>
                    </svg>
                </div>
            </section>
...
<style scoped src="./assets/assets/css/fontawesome.css"></style>
