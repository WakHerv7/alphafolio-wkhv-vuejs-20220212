        ...
        <nav id="primary-navigation" class="site-navigation">
            <div class="container">
                <div class="navbar-header page-scroll">
                    ...
                    <button type="button" class="navbar-toggle collapsed" @click="toggleMenu()" data-target="#portfolio-perfect-collapse" aria-expanded="false" >
                ...
                <div class="main-menu" :class="menuOpen? 'act':''" id="portfolio-perfect-collapse">

                    <ul class="nav navbar-nav navbar-right">

                        <li class="page-scroll"><a href="#hero" @click="toggleMenu()">Home</a></li>
                        <li class="page-scroll"><a href="#about" @click="toggleMenu()">About</a></li>
                        <li class="page-scroll"><a href="#service" @click="toggleMenu()">Service</a></li>
                        <li class="page-scroll"><a href="#portfolio" @click="toggleMenu()">Portfolio</a></li>
                        <li class="page-scroll"><a href="#contact" @click="toggleMenu()">Contact</a></li>
