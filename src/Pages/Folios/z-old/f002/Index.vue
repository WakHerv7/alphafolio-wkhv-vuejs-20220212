<template>
    <div id="page-wraper" class="body-f002">
      <!-- Sidebar Menu -->
      <div class="responsive-nav">
        <i class="fa fa-bars" id="menu-toggle" @click="toggleMenu()"></i>
        <div id="menu" class="menu" :class="menuOpen? 'displayTrue':''">
          <i class="fa fa-times" id="menu-close" @click="toggleMenu()"></i>
          <div class="container">
            <div class="image">
      ...
      <section class="section about-me" id="section1" data-section="section1">
        <div class="container">
      ...
      <section class="section my-services" id="section2" data-section="section2">
        <div class="container">
          <div class="section-heading">
      ...
      <section class="section my-work" id="section3" data-section="section3">
        <div class="container">
          <div class="section-heading">
            <h2>My Work</h2>
            <div class="line-dec"></div>
      ...
      <section class="section contact-me" id="section4" data-section="section4">
        <div class="container">
          <div class="section-heading">
            <h2>Contact Me</h2>
            <div class="line-dec"></div>
...
<style scoped src="./assets/css/templatemo-style.css"></style>
<style scoped src="./assets/css/lightbox.css"></style>
