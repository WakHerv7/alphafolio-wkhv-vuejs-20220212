...
<nav class="navbar" :class="menuOpen? '':'displayNone'">
...
<!-- header section ends -->
<!-- <i class="material-icons-outlined">{{menuOpen? 'close':'menu'}}</i>  -->
<div id="menu" @click="toggleMenu()"><i class="fa fa-bars"></i> </div>
...
<section id="blogs" class="blogs">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                <div class="icons">
                    <a href="#"> <i class="fa fa-calendar"></i> 21st may, 2021 </a>
...
<style scoped src="./css/fontawesome.css"></style>
