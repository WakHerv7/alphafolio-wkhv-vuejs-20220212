<template>
    ...
    <section id="tmWelcome" class="parallax-window" data-parallax="scroll" data-image-src="img/mini-profile-bg-01.jpg">
        <!-- style="background: url(./img/mini-profile-bg-02.jpg);" -->
        <!-- style="background: url(./images/about_04.jpg);" -->
...
<style scoped src="./css/all.min.css"></style>
<style scoped src="./css/bootstrap.min.css"></style>
<style scoped src="./css/templatemo-style.css"></style>
